...
\end{block}
  ...
  \begin{center}
    ...
    \only<+>{\includegraphics[trim=0 0 0 1cm, clip, scale=0.6]{VR_ex_r2.PNG}}
    \only<+>{\includegraphics[trim=0 0 0 1cm, clip, scale=0.6]{VR_ex_r3.PNG}}
  \end{center}
\end{frame}
...
\begin{frame}{Barcodes}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[scale=0.25]{betti1.png}
  \end{minipage}
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[scale=0.25]{betti2.png}
  \end{minipage}
\end{minipage}
\end{frame}
